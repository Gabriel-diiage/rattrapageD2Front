...
export class CharacterService {
  ...
  new Character(2, 'Marie', 'Durand', 28, 'Graphiste et illustratrice freelance'),
  new Character(3, 'Jean', 'Martin', 45, 'Chef de projet dans le secteur IT'),
  new Character(4, 'Sophie', 'Lemoine', 35, 'Experte en marketing digital'),
  ];
